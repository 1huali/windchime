...
window.onload = function() {
        ...
        modeButton.addEventListener("click", function(event) {
            ...
            windChimeElements = windChimeElements.concat(document.querySelectorAll('.mass'), document.querySelectorAll('#plate'), document.querySelectorAll('.strings'), document.querySelectorAll('button'));
